...
export const defaultServices: ServiceItem[] = [
  ...
  },
  {
    ...
    features: ["iOS + Android (MVP)", "Expo managed workflow", "Push notifications", "Pago 50% inicio / 50% entrega"],
    popular: false,
  ...
  },
  {
    ...
    features: ["REST / GraphQL APIs", "MySQL / PostgreSQL", "Autenticación JWT/OAuth", "Pago 50% inicio / 50% entrega"],
    popular: false,
  ...
  },
  {
    ...
    features: ["Next.js + TailwindCSS", "Animaciones Framer Motion", "SEO 100% optimizado", "Pago 50% inicio / 50% entrega"],
    popular: false,
  ...
  },
  {
    ...
    price: "Desde $1,000 USD", category: "producto",
    features: ["Stripe / MercadoPago", "Gestión de inventario", "Carrito + Checkout", "Pago 50% inicio / 50% entrega"],
    popular: false,
  ...
  },
  {
    ...
    features: ["ChatGPT / Claude API", "Chatbots inteligentes", "Generación de contenido", "Pago 50% inicio / 50% entrega"],
    popular: false,
  ...
  },
  {
    ...
    features: ["Reporte técnico + on-page + competencia", "Análisis de Core Web Vitals", "Plan de acción priorizado (PDF)", "Pago 50% inicio / 50% entrega"],
    popular: true,
    deliveryTime: "1-2 semanas",
  },
  {
    ...
    features: ["Meta tags + headings optimizados", "Schema markup (JSON-LD)", "Lighthouse ≥ 90 garantizado", "Pago 50% inicio / 50% entrega"],
    popular: false,
  ...
  },
  {
    ...
    price: "Desde $199 USD", category: "seo",
    features: ["Perfil GMB verificado y optimizado", "Fotos, horarios, servicios configurados", "Vinculación con tu sitio web", "Pago 50% inicio / 50% entrega"],
    popular: false,
    deliveryTime: "1-2 semanas",
  },
  {
    ...
    features: ["30+ keywords con volumen y dificultad", "Análisis de intención de búsqueda", "2 artículos optimizados listos para publicar", "Pago 50% inicio / 50% entrega"],
    popular: false,
    deliveryTime: "2-3 semanas",
  },
];
